...
const ORYANTASYON_SABLONLARI_DETAYLI = {
  "servis müdürü": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 3, baslik: "Hoş Geldin maili paylaşımı", kapsam: "Şirket çalışanlarına işe başlama duyurusunun yapılması", saat: "09.15", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 4, baslik: "Ekibi hakkında genel bilgilendirme", kapsam: "Ekip listesinin verilmesi", saat: "09.30", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 5, baslik: "Şirketin organizasyonel yapısının anlatılması", kapsam: "Organizasyon şeması üzerinden şirketin genel yapısının ve birim liderlerinin anlatılması", saat: "09.45", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 6, baslik: "İşe alım süreçleri bilgilendirme", kapsam: "İşe alım iş akışı, süreçleri ve uygulamaları hakkında bilgilendirme", saat: "10.00", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 7, baslik: "Zimmetlerinin teslim edilmesinin sağlanması", kapsam: "Mail açılması, telefon, bilgisayar gibi zimmetlerin tesliminin IT birimi ile organize edilmesi", saat: "10.15", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 8, baslik: "Tesis yapısının fiziki anlatımı", kapsam: "Servis saatleri, durakları, çalışma saatleri, yemekhane, tesislerin yerleri vb. bilgilendirilmesi", saat: "10.30", sure: "30", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Ceo ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Yönetim Kurulu Başkanı ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 11, baslik: "Veri Odaklı Yönetim", kapsam: "Bayi organizasyonu içindeki diğer birimlerle koordinasyonu sağlamak. Hasar toplantılarına katılmak. Distribütör ile bilgi alışverişi ve raporlamaları yürütmek. Atölye iş akış organizasyonunu kurmak, yetki ve sorumlulukları belirlemek. Prosedürlere uygunluğu takip etmek. Servis müşterilerine ait açık hesapları kontrol etmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 12, baslik: "İş Akışı ve Verimlilik Takibi", kapsam: "Çalışma ortamını gözlemleyerek öncelikleri belirlemek, çalışanlara iş öncelik sırasına göre çalışma alışkanlığı kazandırmak. Atölye iş akışlarının verimli yürütülmesini sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 13, baslik: "Teknik Yönetim ve Denetim", kapsam: "Teşhis konmamış, parça bekleyen araçların durumlarını takip etmek, teknik ekiple birebir iletişim kurmak. Atölye donanımlarını kontrol etmek, bakım ve yenileme planlarını yapmak. Servis süreçlerinde verimliliği artıracak metot ve teknolojileri araştırmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 14, baslik: "Kalite ve Teşhis Süreçleri", kapsam: "Teşhis ve onarım kalitesini artırmak, öncelikli işlerin takibini yapmak, iş gecikmeleri ve plan değişikliklerine yönelik önlem almak. İş gücü, araç, mekan ve malzeme kaynaklarını etkin biçimde planlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 15, baslik: "Envanter ve Ekipman Yönetimi", kapsam: "Servisin tüm alet, edevat, ekipman ve demirbaşlarının güvenliğini sağlamak. Eksiklerin tamamlanması, demirbaş sayımlarının düzenli yapılması, bakım ve onarımlarının yürütülmesini sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 16, baslik: "Tesis Yönetimi", kapsam: "Tesis içi ve dışı düzenin, temizliğin ve tertibin sağlanması. Yasal belge ve süreçlerin yönetilmesi. Alet ve malzeme kullanımının kontrol edilmesi. Gerekli tamirat ve tadilatların yapılmasını sağlamak. Atık yönetim planının uygulanmasını sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 17, baslik: "Müşteri İlişkileri Yönetimi", kapsam: "Müşteri İlişkileri Sorumlusu’ndan gelen kritik müşteri bilgilerini takip etmek, gerekirse ziyaretlerde bulunmak, sorunları çözmek. Müşteri memnuniyetini artırmak, şikayetleri çözüm odaklı yönetmek. Potansiyel müşteri sorunlarını önlemek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 18, baslik: "Müşteri Sadakati ve Pazarlama", kapsam: "Mevcut müşterilerle ilişkileri güçlendirmek, yeni müşteri kazanmak, filo müşterilerini düzenli ziyaret etmek. Servis pazarlama faaliyetlerini planlamak ve uygulamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 19, baslik: "Mali Yönetim", kapsam: "Servisin ciro ve karlılığını yönetmek. İşçilik ücretlerini belirlemek. Parça stokları ve tahsilat süreçlerini izlemek. Nakit akışını dengede tutmak. Yıllık gelir-gider analizleri yapmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 20, baslik: "Bütçe ve Finansal Takip", kapsam: "Servis Departmanı bütçesini planlamak, hedefleri belirlemek, performans verilerini izlemek. Bütçe sapmalarını analiz etmek. Maliyetleri düşürmek için fırsatları tespit etmek. Karlılığı artıracak eylem planlarını oluşturmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 21, baslik: "İnsan Kaynakları Yönetimi", kapsam: "Ekip katılımını kontrol etmek, yeni cihaz kullanımı için eğitim planlamak. Çalışan verimliliğini izlemek, eğitim ve gelişim planları oluşturmak. Günlük/haftalık toplantılar düzenlemek. Yeni işe alınan personelin oryantasyonunu yürütmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 22, baslik: "Ekip Motivasyonu ve Disiplin", kapsam: "İnsan Kaynakları ile iş birliği içinde ekip moralini yüksek tutmak. Disiplin süreçlerini yönetmek, uyarı ve yaptırımlarda İnsan Kaynakları’na bilgi vermek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 23, baslik: "İzin ve Devamlılık Takibi", kapsam: "Ekip yıllık izin planlamasını yapmak, hastalık, doğum, vefat gibi durumlarda İnsan Kaynakları’nı bilgilendirmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 24, baslik: "Görev Dağılımı ve Kapasite Yönetimi", kapsam: "Çalışanların görev dağılımlarını yapmak, beceri ve yeteneklerine göre iş planlamak, teknik bilgi seviyesini yüksek tutmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 25, baslik: "Oryantasyon gidişat toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında İK ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 26, baslik: "Oryantasyon final toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında CEO ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "satış müdürü": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    ...
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Ceo ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Yönetim Kurulu Başkanı ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 11, baslik: "Satış süreçleri, oryantasyon", kapsam: "Satış danışmanları başta olmak üzere kendisine bağlı olan personel ile tanıştırma", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 12, baslik: "Satış müdürleri / Şirket müdürleri ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 13, baslik: "Bölge Müdürü ile tanıştırma", kapsam: "Online toplantı aracılığıyla bölge müdürü ile tanışma", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 14, baslik: "İn Grup Sistemleri Eğitimi", kapsam: "Copilot, Rapor, Föy, Satın Alma, IT sistemlerinin tanıtımı ve kullanımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 15, baslik: "Takas Sistemi", kapsam: "İkinci el takas süreci ve işleyişinin anlatılması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 16, baslik: "Föy Detayları", kapsam: "Tahsilat, fatura ve ek satış süreçlerinin tanıtımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 17, baslik: "Showroom Düzeni", kapsam: "Alanların kuralları, düzeni ve müşteri karşılama alanlarının yönetimi", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 18, baslik: "Araç Alım ve Vadeler", kapsam: "Araç tahsis süreçleri ve vade planlaması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 19, baslik: "Lojistik Süreçleri", kapsam: "Faturalama süreçleri, araç giriş–çıkış ve teslim organizasyonu", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 20, baslik: "PDI", kapsam: "Sisteme giriş ve süreç akışının anlatımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 21, baslik: "Filo Kanalı", kapsam: "Talep ve faturalama süreçlerinin tanıtımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 22, baslik: "ÖTV Kanunu ve Araç ÖTV Dilimleri", kapsam: "Araç ÖTV matrahları ve katılım oranlarının açıklanması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 23, baslik: "Kredi Dilimleri", kapsam: "Araç bedeline göre kredi kullandırım limitlerinin anlatılması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 24, baslik: "Şirket Kültürü", kapsam: "Şirketin temel değerleri, olmazsa olmaz ilkeleri ve olaylara yaklaşım biçimi", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 25, baslik: "Estetik Şirketi Çalışma Prensipleri", kapsam: "Araç estetik işlemleri ve satış politikaları hakkında bilgilendirme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Kurumsal ve Operasyonel Entegrasyon", sira: 26, baslik: "Oryantasyon gidişat toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında İK ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 27, baslik: "Satış Danışmanı Süreçleri", kapsam: "Müşteri ile ilişkilerin kuralları, danışman davranış standartları", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 28, baslik: "Müşteri Yönetimi", kapsam: "Müşteri karşılama ve uğurlama süreçleri", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 29, baslik: "Müşteri İlişkileri", kapsam: "Müşteri şikayetleri ve cevaplama süreçleri", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 30, baslik: "Prim Dönemleri", kapsam: "Araç prim dönemleri ve ödeme tarihleri", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 31, baslik: "Tahsilat Kuralları", kapsam: "Tahsilatlar ve danışmanların para ile olan ilişkilerinin kuralları", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 32, baslik: "Satış Danışmanı Performans Süreçleri", kapsam: "Günlük, haftalık ve aylık hedef planlaması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 33, baslik: "Stok Yaşı Yüksek Araç Hedefi", kapsam: "Stoktaki araçlara göre prim hedefi verilmesi", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 34, baslik: "Satış Müdürü Satış Verme Politikası", kapsam: "Satış müdürünün araç sattığında hangi mantıkla satış vereceği", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 35, baslik: "Prim Sisteminin Anlatılması", kapsam: "Prim sisteminin genel yapısının ve kriterlerinin açıklanması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 36, baslik: "Takip Edilen Satış KPI’ları", kapsam: "Satış performansında izlenen temel göstergeler (adet, brüt kâr, müşteri memnuniyeti vb.)", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 37, baslik: "Veri Odaklı Yönetim", kapsam: "Satış KPI’ları, stok yaş analizi, raporlama araçları (ör. Power BI, Copilot entegrasyonları) konusunda uygulamalı eğitim", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 38, baslik: "2. el ile toplantı", kapsam: "Süreç ve bilgi aktarımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 39, baslik: "Mali İşler departmanı ile tanışma ve iş akışı bilgilendirmesi", kapsam: "Süreç ve bilgi aktarımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Satış Yönetimi ve Performans Süreçleri", sira: 40, baslik: "Pazarlama ekibi ile işbirliği ve birlikte çalışma konularının aktarımı", kapsam: "Süreç ve bilgi aktarımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 41, baslik: "Marka Sistemine Kayıt", kapsam: "e-Link, Salesforce, Efes sistemlerine kayıt ve temel kullanım eğitimi", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 42, baslik: "Marka Dinamikleri", kapsam: "Markaların pazar payı, hedefleri ve rekabet pozisyonlarının anlatılması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 43, baslik: "Marka Yöneticileri", kapsam: "Her markaya bağlı sorumlu alanlardaki kişilerle tanışma", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 44, baslik: "Marka Eğitim", kapsam: "Marka özelinde verilen eğitimlerin kapsamı ve sorumlulukları", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 45, baslik: "Raporlamalar", kapsam: "Satış kayıtları, veri detayları ve rapor formatlarının tanıtımı", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 46, baslik: "Danışman Toplantıları", kapsam: "Toplantı konuları, sıklığı ve zamanlama düzeni", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 47, baslik: "Marka Farklılıkları Workshopu", kapsam: "Markaların farklı müşteri profilleri, satış döngüleri ve fiyatlandırma stratejileri arasındaki farkların vurgulanması", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 48, baslik: "Saha Uygulama Günü", kapsam: "Satış müdürünün bir gününü showroomda danışmanlarla birlikte geçirmesi, müşteri sürecini sahada deneyimlemesi", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "Marka ve Stratejik Yönetim", sira: 49, baslik: "Oryantasyon final toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında CEO ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "yıkama yöneticisi": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 3, baslik: "Hoş Geldin maili paylaşımı", kapsam: "Şirket çalışanlarına işe başlama duyurusunun yapılması", saat: "09.15", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 4, baslik: "Ekibi hakkında genel bilgilendirme", kapsam: "Ekip listesinin verilmesi", saat: "09.30", sure: "15", sorumlu: "Aybüke Kızılay", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 5, baslik: "Şirketin organizasyonel yapısının anlatılması", kapsam: "Organizasyon şeması üzerinden şirketin genel yapısının ve birim liderlerinin anlatılması", saat: "09.45", sure: "15", sorumlu: "Aybüke Kızılay", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 6, baslik: "İşe alım süreçleri bilgilendirme", kapsam: "İşe alım iş akışı, süreçleri ve uygulamaları hakkında bilgilendirme", saat: "10.00", sure: "15", sorumlu: "Aybüke Kızılay & Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 7, baslik: "Zimmetlerinin teslim edilmesinin sağlanması", kapsam: "Mail açılması, telefon, bilgisayar gibi zimmetlerin tesliminin IT birimi ile organize edilmesi", saat: "10.15", sure: "15", sorumlu: "Enes Altunbağ", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 8, baslik: "Tesis yapısının fiziki anlatımı", kapsam: "Servis saatleri, durakları, çalışma saatleri, yemekhane, tesislerin yerleri vb. bilgilendirilmesi", saat: "10.30", sure: "30", sorumlu: "Şahin Tektaş", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Servis direktörü ile tanışma", kapsam: "Mevcut süreçler, hiyerarşi, iş akışı hakkında bilgilendirme", saat: "", sure: "", sorumlu: "Aybüke Kızılay", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 10, baslik: "Yöneticisi olduğu ekip ile tanıştırma", kapsam: "Mevcut ekip yapısı, kullanılan malzemeler, günlük iş akışı, kalite standartları.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 11, baslik: "Peugeot satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 12, baslik: "Citroen satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 13, baslik: "Fiat satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 14, baslik: "Opel satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 15, baslik: "Honda satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 16, baslik: "Filo satış müdürü ile tanışma", kapsam: "Yıkama elemanı, showroom elemanı vb. görevlerin; görev tanımlarının anlatılması. Satış danışmanları ile tanıştırma. Yıkama ekibi ile işbirliği süreçleri hakkında bilgilendirme. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 17, baslik: "Peugeot servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 18, baslik: "Citroen servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 19, baslik: "Fiat servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 20, baslik: "Opel servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 21, baslik: "Honda servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 22, baslik: "Filo servis müdürü ile tanışma", kapsam: "Genel iş akışlarının aktarılması, servis danışmanları ile tanıştırma. Servis sonrası yıkama talepleri, müşteri memnuniyeti beklentileri, iş yoğunluğu dönemleri hakkında bilgi verilmesi. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 23, baslik: "Hasar müdürü ile tanışma", kapsam: "Hasarlı araç yıkama prosedürleri, güvenlik önlemleri, boya ve kimyasal kullanım kısıtları. Araç teslim öncesi kontrol noktaları, kalite ölçüm kriterleri, yıkama sonrası araçta fark edilen hatalarda iletişim şekli, müşteri ile temas noktaları, günlük yıkama raporu, vardiya planı, eksik ve arıza bildirim süreci.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "OPERASYONEL SÜREÇLER", sira: 24, baslik: "İstenilen aylık/haftalık raporlamalar", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "satış danışmanı": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 3, baslik: "Hoş Geldin maili paylaşımı", kapsam: "Şirket çalışanlarına işe başlama duyurusunun yapılması", saat: "09.15", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 4, baslik: "Ekibi hakkında genel bilgilendirme", kapsam: "Ekip listesinin verilmesi", saat: "09.30", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 5, baslik: "Şirketin organizasyonel yapısının anlatılması", kapsam: "Organizasyon şeması üzerinden şirketin genel yapısının ve birim liderlerinin anlatılması", saat: "09.45", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 6, baslik: "İşe alım süreçleri bilgilendirme", kapsam: "İşe alım iş akışı, süreçleri ve uygulamaları hakkında bilgilendirme", saat: "10.00", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 7, baslik: "Zimmetlerinin teslim edilmesinin sağlanması", kapsam: "Mail açılması, telefon, bilgisayar gibi zimmetlerin tesliminin IT birimi ile organize edilmesi", saat: "10.15", sure: "15", sorumlu: "Enes Altunbağ", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 8, baslik: "Tesis yapısının fiziki anlatımı", kapsam: "Servis saatleri, durakları, çalışma saatleri, yemekhane, tesislerin yerleri vb. bilgilendirilmesi", saat: "10.30", sure: "30", sorumlu: "Şahin Tektaş", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Servis direktörü ile tanışma", kapsam: "Mevcut süreçler, hiyerarşi, iş akışı hakkında bilgilendirme", saat: "", sure: "", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Satış Ekibi ve İş Ortakları ile Tanışma", kapsam: "Showroom ekibi ve iş ortaklarıyla tanışma, ekip içi iletişim ve görev tanımlarının anlatılması. Organizasyon yapısına adaptasyonun sağlanması.", saat: "", sure: "", sorumlu: "Satış Müdürü / İnsan Kaynakları", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 11, baslik: "Şirket Kültürü ve Kurallarının Aktarımı", kapsam: "Şirket politikaları, çalışma saatleri, izin prosedürleri, kılık-kıyafet kuralları, marka vizyonu ve misyonunun aktarılması.", saat: "", sure: "", sorumlu: "Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 12, baslik: "Organizasyon Şeması ve Yönetici Görüşmesi", kapsam: "Organizasyon şemasının tanıtılması, yöneticilerle tanışma, hedef ve beklentilerin paylaşılması.", saat: "", sure: "", sorumlu: "Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 13, baslik: "Body (Eşlikçi) Ataması ve Gölgeleme Süreci", kapsam: "Yeni danışmana body atanır, showroom süreci, araç tanıtımı, teklif hazırlığı ve teslimat gözlemi yapılır.", saat: "", sure: "", sorumlu: "Body Danışman / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 14, baslik: "Sistemsel Tanımlamalar ve Talep Süreçleri", kapsam: "Yaka kartı, kartvizit, e-posta, sistem erişimi, kullanıcı yetkileri ve talep süreçlerinin tamamlanması.", saat: "", sure: "", sorumlu: "IT / Satış Destek", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 15, baslik: "Süreç ve Ürün Bilgilendirmesi", kapsam: "Genel satış süreci, showroom işleyişi, müşteri karşılamaya dair bilgilendirme.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 16, baslik: "Ürün Bilgisi Eğitimi", kapsam: "Ürün gamı, donanım seviyeleri, teknik özellikler ve fiyatlandırma detaylarının aktarılması.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 17, baslik: "Hizmet Bilgisi Eğitimi", kapsam: "Müşteri karşılama, ihtiyaç analizi, sunum, teklif hazırlama, kredi bilgilendirme, test sürüşü, zaman yönetimi eğitimi.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 18, baslik: "Mevzuat Bilgilendirmesi", kapsam: "ÖTV, KDV, kredi ve yasal mevzuat hakkında bilgi.", saat: "", sure: "", sorumlu: "Satış Müdürü / Finans", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 19, baslik: "Araç / Hizmet Satışı Sürecine Giriş", kapsam: "Showroom’a gelen müşterinin karşılanması, ihtiyaç analizi, uygun aracın sunulması, gizli müşteri kriterlerinin öğrenilmesi.", saat: "", sure: "", sorumlu: "Satış Müdürü / Eğitim Departmanı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 20, baslik: "Showroom Düzeni ve Teşhir Kontrolü", kapsam: "Showroom içi ve dışı araçların temizliği, teşhir düzeni, görsel bütünlüğün korunması.", saat: "", sure: "", sorumlu: "Showroom Sorumlusu / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 21, baslik: "Müşteri Takip Programı Kullanımı", kapsam: "DMS, Efes vb. müşteri takip sistemlerinin doğru kullanımı, sistem kayıtlarının güncel tutulması.", saat: "", sure: "", sorumlu: "Satış Destek / MİS", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 22, baslik: "Sistem Kullanımı Oryantasyonu", kapsam: "Markaya özel sistemler (Copilot, Takas Takip vb.) hakkında eğitim verilmesi.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 23, baslik: "Stok Kontrolü ve Yönetimi", kapsam: "Araç stoklarının düzenli kontrolü, doğru tahsis ve stok hareket takibi.", saat: "", sure: "", sorumlu: "Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 24, baslik: "Satış Süreci ve Akışı", kapsam: "Müşteri ihtiyacı belirleme, tekliflendirme, satış kapama, sözleşme hazırlığı, kredi ve sigorta süreçleri, plaka ve teslimat işlemleri.", saat: "", sure: "", sorumlu: "Satış Müdürü / Kredi Tahsis Uzmanı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 25, baslik: "Takas Süreçleri", kapsam: "Takas araçların değerlemesi, 2. El Sorumlusu ile koordinasyon, prosedürlere uygun teslim alma.", saat: "", sure: "", sorumlu: "2. El Sorumlusu / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 26, baslik: "Finansal İşlemler", kapsam: "Müşterilerin kredi yönlendirmeleri, bankalarla koordinasyon, kasko ve sigorta işlemlerinin yürütülmesi.", saat: "", sure: "", sorumlu: "Kredi Tahsis Uzmanı / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 27, baslik: "Garanti ve Teslimat Süreçleri", kapsam: "Garanti belgelerinin düzenlenmesi, araç tesliminde belgelerin eksiksiz sunulması.", saat: "", sure: "", sorumlu: "Satış Destek / Teslimat Sorumlusu", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 28, baslik: "Araç Teslimi ve Memnuniyet Araması", kapsam: "Teslimatın marka standartlarına uygun yapılması, teslim sonrası müşteri memnuniyet araması.", saat: "", sure: "", sorumlu: "Satış Danışmanı / MİS", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 29, baslik: "Artı Garanti Satışı", kapsam: "Ek garanti seçeneklerinin müşteriye sunulması ve satış sonrası süreçlere dâhil edilmesi.", saat: "", sure: "", sorumlu: "Satış Danışmanı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 30, baslik: "Kalite ve Müşteri Takip Süreçleri", kapsam: "Müşteri aramaları, anket ve gizli müşteri takibi, teklif adetlerinin kontrolü.", saat: "", sure: "", sorumlu: "Satış Müdürü / MİS", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 31, baslik: "Müşteri Şikayet Yönetimi", kapsam: "Şikayetlerin çözülmesi, çözülemeyen durumların yönlendirilmesi, sonuç takibi.", saat: "", sure: "", sorumlu: "Satış Müdürü / MİS", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 32, baslik: "Kampanyalar ve Promosyonlar", kapsam: "Güncel kampanyaların öğrenilmesi, müşterilere doğru aktarılması.", saat: "", sure: "", sorumlu: "Pazarlama / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 33, baslik: "Satış Hedefleri ve Fiyat Politikası", kapsam: "Satış hedeflerinin belirlenmesi, fiyat ve indirim politikalarına uyum sağlanması.", saat: "", sure: "", sorumlu: "Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 34, baslik: "Satış Hedef Planlaması", kapsam: "Hedeflere ulaşmak için strateji oluşturulması, kişisel satış planının hazırlanması.", saat: "", sure: "", sorumlu: "Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 35, baslik: "Yeni Müşteri Kazanımı", kapsam: "Distribütör ve yerel pazarlama faaliyetleriyle müşteri portföyünün geliştirilmesi.", saat: "", sure: "", sorumlu: "Satış Danışmanı / Pazarlama", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 36, baslik: "Referans Yönetimi ve Aday Takibi", kapsam: "Mevcut müşterilerden referans alınması, potansiyel müşterilerin takibi.", saat: "", sure: "", sorumlu: "Satış Danışmanı / MİS", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 37, baslik: "Yeniden Satış Çalışmaları", kapsam: "Mevcut müşterilerle yeniden iletişim kurularak yeni satış fırsatlarının yaratılması.", saat: "", sure: "", sorumlu: "Satış Danışmanı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 38, baslik: "Ürün Bilgisi Geliştirme", kapsam: "Araçların teknik ve rekabet avantajları hakkında sürekli bilgi güncellemesi.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 39, baslik: "Yasal Sorumluluk ve Finansal Bilgi", kapsam: "Satışın yasal sonuçları, garanti ve finansman süreçleri hakkında bilgi sahibi olunması.", saat: "", sure: "", sorumlu: "Satış Müdürü / Finans", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 40, baslik: "Distribütör Yazılım ve Eğitimleri", kapsam: "Distribütör sistemlerinin (Efes, DMS, Jato vb.) etkin kullanımı, eğitimlere katılım.", saat: "", sure: "", sorumlu: "Satış Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 41, baslik: "Filo ve Özel Satış İşlemleri", kapsam: "Filo veya özel satış müşteri evraklarının eksiksiz hazırlanması ve teslimi.", saat: "", sure: "", sorumlu: "Filo Satış / Satış Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 42, baslik: "Satış Sonrası Müşteri Takibi", kapsam: "Kredi talebi ve tahsilat süreçlerinin takibi, muhasebeye iletilmesi.", saat: "", sure: "", sorumlu: "Satış Danışmanı / Muhasebe", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "oto yıkama elemanı": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    ...
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Ceo ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Yönetim Kurulu Başkanı ile tanıştırma", kapsam: "", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 11, baslik: "Tesis ve İSG Adaptasyonu", kapsam: "Çalışma alanındaki riskli bölgeler, basınçlı makine kullanım güvenliği ve kişisel koruyucu donanımların (çizme, tulum vb.) kullanımı.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 12, baslik: "Şirket Yıkama ve Kimyasal Standardı", kapsam: "Hangi yüzeyde hangi kimyasal kullanılır? Tabanca mesafeleri (30-45 cm kuralı) ve boyaya zarar vermeden yıkama tekniklerinin izlenmesi ve öğrenilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 13, baslik: "Departmanlar Arası İletişim", kapsam: "Aracın servisten veya satıştan geliş süreci, yıkama sırasına alınma mantığı ve biten aracın kime, nasıl teslim edileceğinin öğrenilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 14, baslik: "Son Kontrol ve Müşteri Gözüyle Bakış", kapsam: "Yıkanmış bir aracın teslimden önce \"Müşteri neye bakar?\" (jantlar, kapı içleri, cam lekeleri) kriterlerine göre denetlenmesi eğitimi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 15, baslik: "Oryantasyon gidişat toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında İK ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 16, baslik: "Oryantasyon final toplantısı", kapsam: "Oryantasyon konularının tamamlanma durumu hakkında CEO ile görüşme", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "otomotiv mekanikçisi": [
    ...
    { kategori: "İK SÜREÇLERİ", sira: 8, baslik: "Tesis yapısının fiziki anlatımı", kapsam: "Servis saatleri, durakları, çalışma saatleri, yemekhane, tesislerin yerleri vb. bilgilendirilmesi", saat: "10.30", sure: "30", sorumlu: "Şahin Tektaş", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Servis direktörü ile tanışma", kapsam: "Mevcut süreçler, hiyerarşi, iş akışı hakkında bilgilendirme", saat: "", sure: "", sorumlu: "Aybüke Kızılay", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Araç Kabul ve Sorun Tespiti", kapsam: "Onarım için aracı teslim almak, koruyucu ekipmanı takmak ve arızayı tespit etmek. Müşteri talebini almak ve kayıt altına almak. İlk kez karşılaşılan sorunları formen veya teknik danışman ile paylaşmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 11, baslik: "İş Planı ve Parça Takibi", kapsam: "Atölye planlamasındaki iş planını takip etmek, gerekli yedek parçaları sistem üzerinden iş emrine eklemek ve stok kontrolünü yapmak. İlave parça veya işçilik gerektiğinde servis danışmanını bilgilendirmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 12, baslik: "Onarım İşlemi", kapsam: "Araç üzerinde bakım ve onarım işlemlerini gerçekleştirmek. Katalogda tanımlı özel takımlar varsa kullanmak. İşlemi biten araçları iş emri ile kalite kontrol sorumlusuna teslim etmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 13, baslik: "Ek İş ve Müşteri Bilgilendirme", kapsam: "Müşteri talebinde olmayan fakat değişmesi gereken parçaları tespit etmek, servis danışmanı ve formen aracılığıyla müşteriye bilgi vermek. Bu şekilde servis cirosuna katkı sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 14, baslik: "Araç Teslim ve Koruma", kapsam: "Tamamlanan hasar tamiratlarında yenilenen parçaların eskilerini korumak. Araç başka bir bölümde işlenecekse ilgili kişiye teslim etmek. Teslim öncesi kalite kontrol ve temizlik kontrollerini yapmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 15, baslik: "Kalite Kontrol Takibi", kapsam: "Kalite kontrol sonucunda giderilemeyen hataları teknik danışman veya formen ile birlikte analiz etmek ve kalıcı çözüm üretmek. Kendisiyle ilgili kalite kontrol sorunlarını takip etmek.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 16, baslik: "Cihaz ve Ekipman Kullanımı", kapsam: "Servisteki alet ve özel takımları doğru kullanmak, kalibrasyonlu cihazların bakımını yapmak, kırılan veya bozulmuş ekipmanları servis müdürüne bildirmek ve düzeni sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 17, baslik: "İş Güvenliği Uygulamaları", kapsam: "İş güvenliği kurallarına uygun çalışmak, kişisel koruyucu ekipmanları kullanmak. Çalışma alanındaki riskleri belirleyip servis müdürüne bildirmek, stok ve parçaların güvenliğini sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 18, baslik: "Ekipman ve Malzeme Takibi", kapsam: "Kullanılan cihazların, ölçüm aletlerinin ve özel takımların kullanılabilir durumda olmasını sağlamak. İş güvenliği ekipmanlarının takibini yapmak ve eksikleri bildirerek yenilenmesini sağlamak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 19, baslik: "Gelişim ve Eğitim", kapsam: "Kalite kontrol, cihaz kullanımı ve iş güvenliği konularında gelişmek için amirlerinden ve servis müdüründen eğitim talep etmek ve verilen eğitimlere katılmak.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ],
  "servis danışmanı": [
    { kategori: "İK SÜREÇLERİ", sira: 1, baslik: "İşe girişinin ve özlük dosyasının hazırlanması", kapsam: "Özlük dosyalarının kontrolu, sözleşme imzaları, yüz tanıtma, sicil açma vb.", saat: "08:30", sure: "30", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "İK SÜREÇLERİ", sira: 2, baslik: "İK tanışma", kapsam: "İK ekibi ile tanışma, iletişim kuracağı kişilerin bilgilerinin verilmesi.", saat: "09:00", sure: "15", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    ...
    { kategori: "İK SÜREÇLERİ", sira: 8, baslik: "Tesis yapısının fiziki anlatımı", kapsam: "Servis saatleri, durakları, çalışma saatleri, yemekhane, tesislerin yerleri vb. bilgilendirilmesi", saat: "10.30", sure: "30", sorumlu: "Şahin Tektaş", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 9, baslik: "Servis direktörü ile tanışma", kapsam: "Mevcut süreçler, hiyerarşi, iş akışı hakkında bilgilendirme", saat: "", sure: "", sorumlu: "Sena Bostancı", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 10, baslik: "Satış Ekibi ve İş Ortakları ile Tanışma", kapsam: "Showroom ekibi ve iş ortaklarıyla tanışma, ekip içi iletişim ve görev tanımlarının anlatılması. Organizasyon yapısına adaptasyonun sağlanması.", saat: "", sure: "", sorumlu: "Servis Müdürü / İnsan Kaynakları", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 11, baslik: "Şirket Kültürü ve Kurallarının Aktarımı", kapsam: "Şirket politikaları, çalışma saatleri, izin prosedürleri, kılık-kıyafet kuralları, marka vizyonu ve misyonunun aktarılması.", saat: "", sure: "", sorumlu: "Servis Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 12, baslik: "Organizasyon Şeması ve Yönetici Görüşmesi", kapsam: "Organizasyon şemasının tanıtılması, yöneticilerle tanışma, hedef ve beklentilerin paylaşılması.", saat: "", sure: "", sorumlu: "Servis Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 13, baslik: "Body (Eşlikçi) Ataması ve Gölgeleme Süreci", kapsam: "Yeni danışmana body atanır, showroom süreci, iş süreci, teklif hazırlığı ve teslimat gözlemi yapılır.", saat: "", sure: "", sorumlu: "Body Danışman / Servis Müdürü", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 14, baslik: "Sistemsel Tanımlamalar ve Talep Süreçleri", kapsam: "Yaka kartı, kartvizit, e-posta, sistem erişimi, kullanıcı yetkileri ve talep süreçlerinin tamamlanması.", saat: "", sure: "", sorumlu: "IT / Satış Destek", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 15, baslik: "Süreç ve Ürün Bilgilendirmesi", kapsam: "Genel servis süreci, showroom işleyişi, müşteri karşılamaya dair bilgilendirme.", saat: "", sure: "", sorumlu: "Servis Müdürü / Body Danışman", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 16, baslik: "Müşteri taleplerinin kabulü sürecine giriş", kapsam: "Telefonla veya yüz yüze başvuran müşterilerin karşılanması, araç ve müşteri bilgilerinin alınması, taleplerin değerlendirilmesi. Servis iş yoğunluğu, yedek parça durumu ve aracın mevcut durumuna göre uygun randevunun planlanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 17, baslik: "Randevu öncesi hazırlık", kapsam: "Randevu gününden önce gerekli yedek parçaların kontrol edilmesi ve hazır bulundurulması, eksiklik durumunda müşteriye bilgi verilerek randevunun güncellenmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 18, baslik: "Araç kabul süreci", kapsam: "Müşteri servise geldiğinde aracın teslim alınması, araç kabul alanında müşteriyle birlikte araç kontrolünün yapılması, mevcut hasar ve eksiklerin kayıt altına alınması, koruyucu kılıfların takılması (5 Nokta Kontrolü), müşteri onayının alınması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 19, baslik: "İş Emri oluşturma", kapsam: "Araç için İş Emri Formu’nun eksiksiz doldurulması, yapılacak işlemler ve tahmini maliyetlerin müşteriye açıklanması, onay alınması ve imzaların tamamlanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 20, baslik: "Kampanya ve parça kontrolü", kapsam: "Aracın geri çağırma kampanyalarına dahil olup olmadığının ve kullanılacak parçaların stok durumunun kontrol edilmesi, gerekli bilgilendirmenin parça deposuna iletilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 21, baslik: "Araç takibi ve bilgilendirme", kapsam: "Atölye sürecinde aracın ilerleyişinin takip edilmesi, yapılan işlemler hakkında müşteriye düzenli bilgi verilmesi, müşteri memnuniyetinin sağlanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 22, baslik: "Servis satışı sürecine giriş", kapsam: "Araç kabulü sırasında yapılan araç turunda ek bakım, onarım veya aksesuar ihtiyaçlarının tespiti, müşteriye sunumu ve onayı.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 23, baslik: "Ek satış ve hizmet bilgilendirmesi", kapsam: "Marka tarafından sunulan hizmetlerin, kampanyaların ve önerilen bakım işlemlerinin müşteriye anlatılması; ek satış fırsatlarının değerlendirilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 24, baslik: "Ek işlemler ve onay süreci", kapsam: "Servis sürecinde ortaya çıkan ek işlemler için müşterinin bilgilendirilmesi, tahmini maliyetlerin paylaşılması ve müşteri onayının alınması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 25, baslik: "Tahsilat ve hesap takibi", kapsam: "Haftalık olarak açık müşteri hesaplarının kontrol edilmesi, tahsilatların zamanında gerçekleşmesinin sağlanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 26, baslik: "Araç teslim öncesi kontrol", kapsam: "Onarımı tamamlanan araçların yapılan işlemler doğrultusunda kontrol edilmesi, eksik veya hatalı uygulamaların tespiti, aracın teslim öncesi temizlenmesi ve hazırlanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 27, baslik: "Müşteriye araç teslimi", kapsam: "Aracın teslimi sırasında yapılan işlemlerin, değişen parçaların ve fatura detaylarının müşteriye açıklanması. Müşteri sorularına doğru ve net cevap verilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 28, baslik: "Faturalandırma ve ödeme işlemleri", kapsam: "Tahsilat sürecinde giriş verilerinin doğruluğunun kontrol edilmesi, kredi kartı veya nakit ödeme alınması, fatura kesimi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 29, baslik: "Garanti dışı parça süreci", kapsam: "Garanti kapsamı dışındaki değişen parçaların müşteriye gösterilmesi, isterse teslim edilmesi, bu durumun iş emrine not edilip imzalanması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 30, baslik: "Sonraki bakım ve bilgilendirme", kapsam: "Müşteriye bir sonraki bakım tarihi ve kilometre bilgisinin verilmesi, memnuniyet anketi hakkında bilgilendirme yapılması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 31, baslik: "Yasal bilgilendirme ve müşteri onayı", kapsam: "Şirketin zorunlu gördüğü bakım/onarım işlemlerinin müşteriye açıklanması, reddetmesi durumunda imza alınması.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 32, baslik: "Müşteri ve araç verilerinin güncellenmesi", kapsam: "Her araç girişinde müşteri ve araç bilgilerinin kontrol edilmesi, sigorta, kasko, egzoz muayenesi gibi eksiklerin belirlenip müşteriye bildirilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null },
    { kategori: "ORYANTASYON SÜREÇLERİ", sira: 33, baslik: "Servis sonrası süreç bilgilendirmesi", kapsam: "Müşterinin araç tesliminden sonra TOFAŞ memnuniyet anketi hakkında bilgilendirilmesi, hizmet kalitesi geri bildiriminin teşvik edilmesi.", saat: "", sure: "", sorumlu: "", tamamlandi: false, tamamlanmaTarihi: null }
  ]
};
...
function oryantasyonFormuHtml(a) {
  ...
  const td = "padding:6px 8px;border:1px solid #e2e8e5;font-size:10.5px;vertical-align:top";
  const rows = Object.keys(kat).map((k) =>
    `<tr><td colspan="7" style="padding:7px 10px;border:1px solid #e2e8e5;background:#eef2f0;font-weight:700;color:#0b5548;font-size:10.5px;letter-spacing:.02em">${esc(k)}</td></tr>` +
    kat[k].map((m) => `<tr>
      <td style="${td};text-align:center;width:30px;color:#8496a0">${m.sira != null ? m.sira : ""}</td>
      <td style="${td}"><b>${esc(m.baslik || m.ad || "")}</b>${m.kapsam ? `<div style="color:#56676f;font-size:9.8px;margin-top:2px;line-height:1.4">${esc(m.kapsam)}</div>` : ""}</td>
      <td style="${td};text-align:center;width:42px">${esc(m.saat || "")}</td>
      <td style="${td};text-align:center;width:42px">${esc(m.sure || "")}</td>
      <td style="${td};width:120px;color:#4a5568">${esc(m.sorumlu || "")}</td>
      <td style="${td};text-align:center;width:48px;font-weight:700;color:${m.tamamlandi ? '#2f6b45' : '#95541a'}">${m.tamamlandi ? '✓' : '—'}</td>
      <td style="${td};text-align:center;width:74px;color:#56676f">${(m.tamamlanmaTarihi || m.tarih) ? fmtTarih(m.tamamlanmaTarihi || m.tarih) : ""}</td>
    </tr>`).join("")).join("");
  const th = "padding:7px 8px;border:1px solid #e2e8e5;background:#0b5548;color:#fff;font-size:9.5px;text-align:left";
  return `<div style="max-width:185mm;margin:0 auto;font-size:12px;color:#132029">${formLetterhead("Oryantasyon Formu")}
    <h2 style="font-family:'Source Serif 4',Georgia,serif;font-size:18px;margin:0 0 14px">Oryantasyon (Onboarding) Takip Formu</h2>
    ${calisanBilgiHtml(a)}
    ...
    <table style="width:100%;border-collapse:collapse;margin:0 0 14px">
      <tr><th style="${th};text-align:center;width:30px">Sıra</th><th style="${th}">Gün Planı / Kapsam</th><th style="${th};text-align:center;width:42px">Saat</th><th style="${th};text-align:center;width:42px">Süre (dk)</th><th style="${th};width:120px">Sorumlu</th><th style="${th};text-align:center;width:48px">Durum</th><th style="${th};text-align:center;width:74px">Tarih</th></tr>
      ${rows || `<tr><td colspan="7" style="padding:12px;border:1px solid #e2e8e5;text-align:center;color:#8496a0">Oryantasyon maddesi bulunmuyor.</td></tr>`}
    </table>
    ${imzaBlokHtml()}</div>`;
}
...
const BOYUT_YORUM = {
  musteri:[
    "Müşteri odaklılık bu düzeydeki bir kişi, müşterinin ihtiyaç ve beklentilerini fark etmekte belirgin biçimde zorlanır ve etkileşim sırasında çoğunlukla kendi önceliklerine ya da sürecin işleyişine odaklanır. Talebin arkasındaki asıl beklentiyi anlamak yerine yüzeydeki isteğe göre hareket etme eğilimindedir; bu nedenle sunduğu çözümler müşterinin gerçek ihtiyacını her zaman karşılamaz. Yoğunluk ya da baskı arttığında müşteri deneyimi kolaylıkla ikinci plana düşebilir ve memnuniyet olumsuz etkilenebilir. Bu yetkinliğin iş sonuçlarına yansıması için müşteriyle temas eden süreçlerde yakın yönlendirme, örnek senaryolar üzerinden koçluk ve düzenli geri bildirim gereklidir. Kısa vadede kritik müşteri temaslarında yalnız bırakılmaması, deneyimli bir çalışanla birlikte çalıştırılması önerilir.",
    "Müşteri beklentilerini temel düzeyde karşılar; rutin ve alışıldık taleplerde makul bir hizmet sunar, ancak müşteri odağını her koşulda koruyamaz. Talebi genellikle doğru anlar fakat beklentinin ötesine geçen, fark yaratan çözümler üretmekte isteksiz ya da yetersiz kalabilir. Özellikle yoğun, zorlu ya da şikâyet içeren durumlarda sabrı ve çözüm üretme enerjisi azalabilir; bu da müşteride 'yeterince ilgilenilmedi' algısı bırakabilir. Müşteriyi aktif dinleme, doğru soruları sorma ve ihtiyacı derinlemesine anlama alışkanlıklarının güçlendirilmesi bu kişiyi belirgin biçimde ileriye taşır. Uygun mentorluk ve net hizmet standartlarıyla desteklendiğinde performansı istikrar kazanır.",
    "Müşteri ihtiyaçlarını genel olarak doğru okur ve beklenen düzeyde, güvenilir bir hizmet sunar. Müşteriyi dinler, talebi anlar ve çoğu durumda memnuniyeti gözeterek hareket eder; rutin süreçleri sorunsuz yönetir. Alışılmadık, karmaşık ya da gergin durumlarda zaman zaman önceliklendirmede veya beklentiyi tam karşılamada ek yönlendirmeye ihtiyaç duyabilir. Beklentinin ötesine geçen proaktif çözümleri her zaman kendiliğinden üretmese de, yönlendirildiğinde bunları uygulayabilir. Bu düzey, çoğu müşteri temaslı rol için yeterli bir zemin sunar; hedefli gelişimle üst banda taşınabilir.",
    "Müşteri odaklılığı güçlü bir yönüdür; müşteriyi dikkatle dinler, talebin arkasındaki asıl ihtiyacı doğru okur ve sıklıkla beklentinin ötesine geçen çözümler sunar. Zorlu ya da şikâyet içeren durumları genellikle sakin, yapıcı ve çözüm odaklı bir tutumla yönetir; müşteride güven ve memnuniyet yaratır. İlişkiyi tek seferlik bir işlemin ötesinde ele alma ve kalıcı memnuniyet oluşturma eğilimi taşır. Nadiren, aynı anda çok sayıda müşteri ya da yoğun baskı söz konusu olduğunda önceliklendirmede kısa süreli zorlanabilir. Genel olarak müşteri temaslı rollerde güvenle görevlendirilebilir ve çevresine örnek olabilir.",
    "Müşteri odaklılık bu kişinin en belirgin güçlü yönlerinden biridir; müşterinin ihtiyacını çoğu zaman dile getirilmeden önce sezer ve proaktif biçimde karşılar. En zorlu, gergin ya da beklenmedik durumlarda dahi müşteri deneyimini merkezde tutar, sakinliğini korur ve güven veren bir ilişki kurar. Sunduğu çözümler yalnızca anlık talebi değil, uzun vadeli memnuniyeti ve sadakati de gözetir. Müşteri geri bildirimlerini bir gelişim fırsatı olarak değerlendirir ve hizmet kalitesini sürekli yükseltme eğilimindedir. Bu düzeydeki bir çalışan, müşteri ilişkilerinde kuruma değer katar ve ekip için rol model olabilir."],
  ikna:[
    "İkna ve etkileme bu düzeydeki bir kişi, görüşünü karşı tarafa etkili biçimde aktarmakta ve onu yönlendirmekte belirgin biçimde zorlanır. Argümanlarını yapılandırma, doğru gerekçelerle destekleme ve karşı tarafın itirazlarını karşılama konusunda yetersiz kalır; bu nedenle görüşleri çoğunlukla karşılık bulmaz. Dirençle ya da farklı bir bakış açısıyla karşılaştığında hızla geri çekilebilir veya ısrarını kaybedebilir. Bu yetkinliğin gelişmesi için mesaj kurgulama, itiraz yönetimi ve etkili sunum konularında yapılandırılmış eğitim ve pratik gerekir. Müzakere ya da ikna gerektiren kritik görüşmelerde tek başına bırakılmaması önerilir.",
    "Basit ve düşük dirençli durumlarda görüşünü aktarabilir, ancak karşısında itiraz ya da güçlü bir görüş olduğunda ikna gücü belirgin biçimde zayıflar. Argümanlarını çoğu zaman yeterince gerekçelendiremez ve karşı tarafın bakış açısını okuyup mesajını buna göre uyarlamakta güçlük çeker. Tartışmalı konularda ya sürece hâkim olamaz ya da ısrarını erken bırakır. Etkili soru sorma, fayda odaklı anlatım ve itirazları fırsata çevirme tekniklerinin geliştirilmesi bu kişiyi ileriye taşır. Deneyimli bir çalışanla birlikte yürütülen görüşmelerle pratiği artırıldığında gelişim gösterir.",
    "Görüşlerini beklenen düzeyde savunur ve çoğu durumda karşı tarafı yönlendirebilir; makul bir ikna gücüne sahiptir. Rutin satış ya da müzakere durumlarında argümanlarını aktarır ve sonuç alabilir. Ancak karmaşık, yüksek dirençli ya da çok taraflı durumlarda ikna gücünü artırmak için daha güçlü gerekçelendirmeye ve karşı tarafın motivasyonunu daha iyi okumaya ihtiyaç duyar. İtirazları genellikle karşılar fakat her zaman fırsata çeviremez. Bu düzey, standart ikna gerektiren roller için yeterlidir; ileri müzakere becerileriyle güçlendirilebilir.",
    "İkna ve etkileme güçlü bir yönüdür; argümanlarını doğru gerekçelerle kurar, mesajını karşı tarafa uygun biçimde uyarlar ve onu etkili şekilde yönlendirir. İtirazları çoğunlukla yapıcı bir tutumla, karşı tarafı savunmaya itmeden karşılar ve müzakereyi ortak bir zemine taşır. Karşısındakinin önceliklerini ve motivasyonlarını okuyarak anlatımını buna göre şekillendirir. Nadiren, çok dirençli ya da duygusal olarak yüklü müzakerelerde istediği sonuca ulaşmakta zorlanabilir. Satış, müzakere ve ikna gerektiren rollerde güvenle görevlendirilebilir.",
    "İkna ve etkileme bu kişinin en güçlü yönlerinden biridir; en zorlu muhataplarda dahi doğru argüman, doğru zamanlama ve doğru dille sonuç alır. Karşı tarafın bakış açısını, önceliklerini ve çekincelerini hızla okur ve mesajını ustalıkla buna göre kurgular. İtirazları bir engel değil, güven inşa etme ve ihtiyacı derinleştirme fırsatı olarak kullanır. Müzakerelerde hem kararlı hem de ilişkiyi koruyan bir denge kurar; karşı tarafta baskı hissi yaratmadan yönlendirir. Bu düzeydeki bir çalışan, kritik satış ve müzakerelerde kuruma belirgin rekabet avantajı sağlar."],
  iletisim:[
    "İletişim becerisi bu düzeydeki bir kişi, bilgiyi açık, doğru ve anlaşılır biçimde aktarmakta belirgin güçlük çeker; mesajları çoğu zaman eksik, dağınık ya da yanlış anlaşılmaya açıktır. Aktif dinleme ve karşı tarafın söylediğini doğru anlama konusunda da zayıflıklar görülür; bu da bilgi kayıplarına ve tekrar eden hatalara yol açabilir. Yazılı ve sözlü iletişimde karşı tarafın seviyesine ve ihtiyacına göre uyarlama yapmakta zorlanır. Net mesaj kurma, dinleme ve geri bildirim alışkanlıklarının yapılandırılmış biçimde geliştirilmesi gerekir. İletişimin kritik olduğu görevlerde yakın destek ve kontrol önerilir.",
    "Temel iletişimi kurar ve gündelik alışverişi yürütebilir, ancak mesajını her zaman net ve eksiksiz aktaramaz. Karmaşık konuları sadeleştirmede, önemli noktaları öne çıkarmada ve karşı tarafın anlayıp anlamadığını teyit etmede zaman zaman zorlanır. Aktif dinleme konusunda gelişime açıktır; bazen karşı tarafı tam dinlemeden yanıt verebilir. Doğru soru sorma, mesajı yapılandırma ve dinleyiciye göre dil seçme becerilerinin güçlendirilmesi belirgin fayda sağlar. Uygun geri bildirim ve pratikle iletişimi istikrar kazanır.",
    "Beklenen düzeyde açık ve anlaşılır bir iletişim kurar; karşı tarafı genellikle doğru anlar ve kendini anlaşılır biçimde ifade eder. Rutin iş iletişimini, bilgilendirmeyi ve gündelik etkileşimleri sorunsuz yürütür. Karmaşık, teknik ya da hassas konuları sadeleştirme ve karşı tarafın seviyesine göre uyarlama konusunda zaman zaman gelişime açıktır. Aktif dinleme becerisi genel olarak yeterlidir; yoğunlukta netliği bir miktar azalabilir. Bu düzey, çoğu rol için sağlam bir iletişim zemini sunar.",
    "İletişim becerisi güçlü bir yönüdür; en karmaşık konuları bile sade, doğru ve karşı tarafa uygun biçimde aktarır. İyi bir dinleyicidir; doğru sorular sorarak karşısındakini tam olarak anlar ve güçlü bir bağ kurar. Yazılı ve sözlü iletişimde tonu ve dili duruma göre esnek biçimde ayarlar. Nadiren, çok yoğun ya da duygusal olarak gergin durumlarda mesajının netliği kısa süreli etkilenebilir. Ekip içi ve müşteriyle iletişimin kritik olduğu rollerde güvenle görevlendirilebilir.",
    "İletişim bu kişinin en belirgin güçlü yönlerinden biridir; en karmaşık ya da hassas konuları dahi olağanüstü bir netlik ve ustalıkla aktarır. Aktif dinleme ve empati kurma becerisi yüksektir; karşısındakinin hem söylediğini hem söylemediğini okuyarak iletişimi yönetir. Mesajını dinleyicinin bilgi düzeyine, duygu durumuna ve önceliğine göre kusursuz biçimde uyarlar. Zorlu ve gergin durumlarda dahi sakin, yapıcı ve güven veren bir iletişim sürdürür. Bu düzeydeki bir çalışan, iletişimiyle ekibe ve müşteri ilişkilerine belirgin değer katar."],
  sonuc:[
    "Sonuca ulaşma azmi bu düzeydeki bir kişi, hedefe yönelik çabasını engellerle karşılaştığında hızla kaybedebilir ve işi tamamlamadan bırakma eğilimi gösterebilir. Zorluk, belirsizlik ya da tekrar eden aksilikler karşısında motivasyonu belirgin biçimde düşer. Uzun soluklu ve ısrar gerektiren görevlerde takip ve dış destek olmadan sonucu getirmekte zorlanır. Net ara hedefler, düzenli takip ve motive edici geri bildirimle desteklenmesi gerekir. Sonuç sorumluluğu yüksek görevlerde yakından izlenmesi önerilir.",
    "Belirlenen hedefe yönelir ve normal koşullarda işini yürütür, ancak zorluklar arttığında ısrarını her zaman koruyamaz. Engellerle karşılaştığında alternatif yol arama ve çözüm üretme enerjisi zaman zaman yetersiz kalabilir. Kısa vadeli ve net görevlerde daha başarılıdır; uzun soluklu, dirençli hedeflerde tempo düşüşü yaşayabilir. Ara hedeflerle ilerlemenin görünür kılınması ve düzenli takip, sonucu getirme olasılığını belirgin biçimde artırır. Uygun hedef yapısı ve destekle performansı istikrar kazanır.",
    "Hedeflerine beklenen düzeyde odaklanır ve çoğu durumda sonucu getirir; makul bir azim ve sorumluluk sergiler. Rutin engelleri aşar ve işini genellikle tamamlar. Çok uzun soluklu, üst üste aksilik içeren ya da yüksek dirençli hedeflerde kararlılığını sürdürmede zaman zaman desteğe ihtiyaç duyabilir. Başarı motivasyonu yeterlidir; güçlü bir hedef ve geri bildirim ortamında daha da yükselir. Bu düzey, çoğu rol için güvenilir bir sonuç odaklılık sunar.",
    "Sonuca ulaşma azmi güçlü bir yönüdür; hedefe kilitlenir ve engellere rağmen sonucu getirme konusunda kararlı davranır. Aksiliklerle karşılaştığında alternatif yollar arar, vazgeçmez ve işi tamamlamaya odaklanır. Başarı motivasyonu yüksektir; kendini ve çoğu zaman çevresini de sonuç almaya yönlendirir. Nadiren, çok uzun süren ya da art arda gelen zorlu hedeflerde temposu geçici olarak değişebilir. Hedef ve sonuç sorumluluğu yüksek rollerde güvenle görevlendirilebilir.",
    "Sonuca ulaşma azmi bu kişinin en belirgin güçlü yönlerindendir; en zorlu koşullarda dahi hedefinden vazgeçmez ve işi sonuçlandırmak için yaratıcı yollar bulur. Engelleri bir durma noktası değil, aşılması gereken bir aşama olarak görür ve yüksek bir kararlılıkla ilerler. Başarı motivasyonu son derece güçlüdür ve bu enerji çevresine de yayılarak ekibi sonuç almaya yönlendirir. Uzun soluklu ve baskılı hedeflerde bile temposunu ve odağını korur. Bu düzeydeki bir çalışan, zorlu hedeflerin hayata geçmesinde kuruma büyük katkı sağlar."],
  dayaniklilik:[
    "Dayanıklılık ve stres yönetimi bu düzeydeki bir kişi, baskı ve stres altında sakinliğini ve performansını korumakta belirgin biçimde zorlanır. Yoğunluk, eleştiri ya da beklenmedik zorluklar karşısında gerginliği hızla artabilir ve bu durum karar kalitesine ve iletişimine yansıyabilir. Olumsuz bir deneyimin ardından toparlanması zaman alabilir ve motivasyonu uzun süre etkilenebilir. Stresle başa çıkma stratejileri, duygu düzenleme ve öz farkındalık konularında desteğe ihtiyaç duyar. Yüksek baskılı ve tempolu görevlerde yıpranma riskine karşı yakından izlenmesi önerilir.",
    "Normal koşullarda dengeli ve üretken çalışır, ancak baskı yoğunlaştığında performansı ve ruh hâli belirgin biçimde etkilenebilir. Art arda gelen zorluklar ya da eleştiriler karşısında gerginlik yaşayabilir ve toparlanması beklenenden uzun sürebilir. Öngörülebilir iş yükünde başarılıdır; belirsizlik ve ani değişimlerde zorlanma eğilimi gösterir. Stres yönetimi tekniklerinin ve destekleyici bir çalışma ortamının bu kişiyi belirgin biçimde güçlendireceği görülür. Uygun iş yükü dengesiyle performansı istikrar kazanır.",
    "Beklenen düzeyde stres toleransına sahiptir; çoğu zorlu durumu dengeli biçimde yönetir ve makul sürede toparlanır. Gündelik baskıları ve rutin gerilimleri sorunsuz karşılar. Baskının olağanüstü yoğunlaştığı, üst üste kriz yaşanan durumlarda zaman zaman gerilim yaşayabilir. Genel olarak iş temposunu ve performansını koruyabilir; yoğun dönemlerde destekleyici bir yönetim yaklaşımından fayda görür. Bu düzey, çoğu rol için yeterli bir dayanıklılık sunar.",
    "Dayanıklılık güçlü bir yönüdür; baskı altında genellikle sakin kalır, hızlı toparlanır ve performansını korur. Zorlu durumları bir tehdit değil, çözülmesi gereken bir mesele olarak karşılar ve soğukkanlılığını sürdürür. Aksiliklerin ardından motivasyonunu koruyarak yeniden odaklanabilir. Nadiren, art arda gelen çok yoğun ve uzun süreli baskı dönemlerinde yıpranma yaşayabilir. Tempolu ve baskılı rollerde güvenle görevlendirilebilir ve ekip için dengeleyici bir unsur olabilir.",
    "Dayanıklılık ve stres yönetimi bu kişinin en güçlü yönlerinden biridir; en yoğun baskı ve belirsizlik altında dahi sakin, dengeli ve üretken kalır. Zorlukları çoğu zaman bir fırsata ya da gelişim alanına çevirir ve krizlerde çevresine güven veren bir duruş sergiler. Olumsuzlukların ardından hızla toparlanır, motivasyonunu ve odağını korur. Yüksek tempolu ve stresli ortamlarda performansı düşmek yerine çoğu zaman istikrarını korur veya artar. Bu düzeydeki bir çalışan, kriz anlarında ekibin dayanağı olabilir."],
  detay:[
    "Detay ve doğruluk bu düzeydeki bir kişi, ayrıntılara dikkat etme ve hata yakalama konusunda belirgin biçimde zorlanır; işleri eksik ya da hatalı tamamlayabilir. Sayısal, yazılı ya da işlemsel verilerde gözden kaçırmalar sık görülebilir ve bu hatalar çoğunlukla kendiliğinden fark edilmez. Zaman baskısı ya da iş yükü arttığında doğruluk oranı daha da düşer. Kontrol listeleri, çift kontrol mekanizmaları ve düzenli gözden geçirme alışkanlıklarıyla desteklenmesi gerekir. Doğruluğun kritik olduğu (evrak, ödeme, kayıt) görevlerde ikinci bir kontrol katmanı önerilir.",
    "Temel doğruluğu sağlar ve rutin işleri makul biçimde tamamlar, ancak yoğunlukta ya da tekrar eden görevlerde detayları gözden kaçırabilir. Hataları her zaman kendiliğinden fark etmez; genellikle bir hatırlatma ya da kontrol sonrası düzeltir. İş yükü arttığında titizliği bir miktar azalabilir. İşini teslim etmeden önce gözden geçirme ve kontrol alışkanlığının yerleşmesi bu kişiyi belirgin biçimde güçlendirir. Net standartlar ve geri bildirimle doğruluk düzeyi yükselir.",
    "Beklenen düzeyde titizlikle çalışır; çoğu hatayı fark eder ve işini genellikle doğru tamamlar. Rutin görevlerde güvenilir bir doğruluk sergiler. Zaman baskısının yoğun olduğu ya da iş yükünün ağırlaştığı durumlarda detayda küçük kayıplar yaşayabilir. Genel olarak dikkatini sürdürebilir; kritik işlerde ek bir kontrol adımından fayda görür. Bu düzey, çoğu rol için yeterli bir doğruluk zemini sunar.",
    "Detay ve doğruluk güçlü bir yönüdür; hataları çoğunlukla erkenden ve kendiliğinden yakalar, işini eksiksiz teslim eder. Ayrıntıya özen gösterir ve yoğun koşullarda dahi titizliğini büyük ölçüde korur. Sayısal ve işlemsel verilerle güvenilir biçimde çalışır. Nadiren, olağanüstü yoğun ya da uzun süreli görevlerde ufak kaçaklar olabilir. Doğruluğun önemli olduğu rollerde güvenle görevlendirilebilir.",
    "Detay ve doğruluk bu kişinin en belirgin güçlü yönlerindendir; hataları erkenden yakalar, işini kusursuza yakın bir doğrulukla teslim eder ve yüksek güvenilirlik sağlar. Baskı ve yoğunluk altında bile titizliğini korur; karmaşık ve çok adımlı işlemlerde dahi tutarlılığını sürdürür. Verideki en küçük tutarsızlığı fark edecek keskin bir dikkate sahiptir. İşini teslim etmeden önce kendi kendini denetleme alışkanlığı yerleşiktir. Bu düzeydeki bir çalışan, doğruluğun kritik olduğu süreçlerde kuruma önemli bir güvence sunar."],
  ekip:[
    "Takım çalışmasına yatkınlık bu düzeydeki bir kişi, ekiple uyum ve iş birliği konusunda belirgin biçimde zorlanır ve çoğunlukla bireysel çalışmayı tercih eder. Bilgi paylaşımı, ortak sorumluluk alma ve grup hedefine katkı konularında isteksiz ya da kapalı kalabilir. Anlaşmazlık durumlarında yapıcı bir tutum geliştirmekte güçlük çeker ve gerilimi büyütebilir. Ekip içi iletişim, ortak hedef bilinci ve iş birliği davranışlarının geliştirilmesi için yönlendirmeye ihtiyaç duyar. Yoğun takım çalışması gerektiren rollerde uyum açısından yakından izlenmesi önerilir.",
    "Takım içinde çalışabilir ve gerektiğinde katkı verir, ancak iş birliğini her zaman aktif biçimde kurmaz. Bilgi paylaşımı ve ortak sorumluluk konusunda zaman zaman çekingen ya da mesafeli kalabilir. Uyumu genellikle korur fakat anlaşmazlık ya da baskı anlarında iş birliğini sürdürmede zorlanabilir. Ekip hedeflerine katkıyı ve açık iletişimi güçlendirecek geri bildirim ve rol netliği bu kişiyi ileriye taşır. Destekleyici bir ekip ortamında yatkınlığı artar.",
    "Beklenen düzeyde bir takım oyuncusudur; ortak hedeflere katkı verir, ekiple uyum sağlar ve bilgi paylaşır. Rutin iş birliği durumlarında yapıcı ve güvenilir davranır. Anlaşmazlık, rekabet ya da baskı anlarında iş birliğini sürdürmede zaman zaman desteğe ihtiyaç duyabilir. Genel olarak ekip içinde olumlu bir rol üstlenir; güçlü bir takım kültüründe daha da etkin olur. Bu düzey, çoğu rol için sağlam bir ekip uyumu sunar.",
    "Takım çalışması güçlü bir yönüdür; ekiple uyumlu çalışır, bilgi ve deneyimini paylaşır ve ortak başarıya belirgin katkı verir. Anlaşmazlıkları çoğunlukla yapıcı biçimde yönetir ve grup içinde olumlu bir hava oluşturur. Gerektiğinde inisiyatif alır, gerektiğinde destekleyici bir rol üstlenir. Nadiren, yoğun rekabet ya da yüksek gerilim ortamında iş birliğini sürdürmede zorlanabilir. Takım odaklı rollerde güvenle görevlendirilebilir.",
    "Takım çalışmasına yatkınlık bu kişinin en güçlü yönlerinden biridir; iş birliğini yalnızca sürdürmekle kalmaz, aktif olarak kurar, güçlendirir ve grubu ortak hedefe taşır. Farklı görüşleri uzlaştırma, çatışmaları yapıcı biçimde çözme ve destekleyici bir ekip ortamı yaratma konusunda belirgin bir yeteneği vardır. Bilgi ve deneyimini cömertçe paylaşır ve ekip arkadaşlarının gelişimine katkı sağlar. Yüksek gerilimli durumlarda bile iş birliğini ve grup moralini koruyabilir. Bu düzeydeki bir çalışan, ekip performansını ve bağlılığını yükselten bir unsurdur."],
  liderlik:[
    "Liderlik ve koçluk bu düzeydeki bir kişi, yönlendirme yapma, sorumluluk alma ve ekibi geliştirme konusunda belirgin biçimde zorlanır. Karar verme anlarında tereddüt edebilir, inisiyatif almaktan kaçınabilir ve ekibe net bir yön gösteremeyebilir. Ekip üyelerine geri bildirim verme, onları geliştirme ve motive etme davranışları henüz oturmamıştır. Liderlik potansiyelinin gelişmesi için mentorluk, kademeli sorumluluk ve yapılandırılmış gelişim programı gerekir. Doğrudan ekip yönetimi gerektiren rollere kısa vadede hazır değildir.",
    "Sınırlı ölçüde sorumluluk alır ve belirli görevlerde yönlendirme yapabilir, ancak ekibi geliştirme ve zorlu kararlar alma konusunda çekingen kalabilir. Karar anlarında zaman zaman erteleme ya da onay arama eğilimi gösterir. Koçluk ve geri bildirim verme becerileri gelişime açıktır. Kademeli olarak artan sorumluluklar, iyi bir mentor ve karar alma pratiğiyle liderlik yönü güçlenebilir. Denetimli bir ortamda küçük ekiplerle deneyim kazanması önerilir.",
    "Beklenen düzeyde yönlendirme yapar ve sorumluluk alır; ekibini gündelik işleyişte yönetebilir. Rutin kararları makul biçimde verir ve ekip üyelerine temel yönlendirmeyi sağlar. Zorlu kararlar, çatışma yönetimi ve ekip geliştirme konularında zaman zaman daha fazla inisiyatif ve derinlik göstermesi beklenir. Koçluk becerisi gelişmeye açıktır; uygun destekle güçlenir. Bu düzey, denetimli liderlik rolleri için yeterli bir temel sunar.",
    "Liderlik ve koçluk güçlü bir yönüdür; sorumluluk alır, ekibini net biçimde yönlendirir ve üyelerinin gelişimine katkı verir. Kararlarını çoğunlukla zamanında, gerekçeli ve kararlı biçimde alır; ekibe güven verir. Geri bildirim verme, motive etme ve çatışmaları yönetme konusunda etkilidir. Nadiren, çok belirsiz ya da yüksek riskli durumlarda karar almada kısa süreli tereddüt yaşayabilir. Ekip yönetimi ve liderlik rolleri için güçlü bir adaydır.",
    "Liderlik ve koçluk bu kişinin en belirgin güçlü yönlerindendir; ekibi ortak bir vizyon etrafında birleştirir, motive eder ve sürekli geliştirir. Zorlu ve belirsiz durumlarda dahi kararlılıkla, sorumluluk alarak ve gerekçeli biçimde karar verir. Ekip üyelerinin güçlü yönlerini görür, onları doğru rollere yönlendirir ve gelişimlerine bizzat katkı sağlar. Çevresinde güven, bağlılık ve yüksek performans kültürü oluşturur. Bu düzeydeki bir çalışan, yönetici ve lider rollerinde kuruma stratejik değer katar."],
  analitik:[
    "Analitik muhakeme bu düzeydeki bir kişi, olaylar arasında neden-sonuç ilişkisi kurma ve veriyi yorumlama konusunda belirgin biçimde zorlanır. Çok değişkenli ya da karmaşık sorunlarda ilişkileri göremeyebilir ve yüzeysel çıkarımlarla hareket edebilir. Karar verirken gerekli bilgileri toplama, ayıklama ve mantıklı bir sonuca ulaşma sürecinde yapılandırılmış desteğe ihtiyaç duyar. Problem çözme çerçeveleri, örnek vaka çalışmaları ve yönlendirilmiş analiz pratiğiyle gelişebilir. Analitik yoğunluğu yüksek görevlerde yalnız bırakılmaması önerilir.",
    "Basit ve tanıdık durumlarda muhakeme yürütebilir, ancak çok değişkenli, belirsiz ya da karmaşık sorunlarda ilişkileri kurmakta zorlanır. Veriyi yorumlama ve bundan mantıklı çıkarımlar üretme konusunda zaman zaman desteğe ihtiyaç duyar. Aceleci ya da eksik analizle sonuca gidebilir. Analiz adımlarını yapılandırma, varsayımları sorgulama ve alternatifleri değerlendirme alışkanlıklarının geliştirilmesi bu kişiyi ileriye taşır. Deneyimli biriyle birlikte yürütülen analizlerle gelişim gösterir.",
    "Beklenen düzeyde analitik düşünür; neden-sonuç ilişkilerini genellikle doğru kurar ve makul çıkarımlar üretir. Rutin ve orta karmaşıklıktaki sorunları çözümleyebilir ve veriye dayalı kararlar verebilir. Çok karmaşık, yüksek belirsizlik içeren ya da çok sayıda değişkenin olduğu durumlarda derin analizde zaman zaman zorlanabilir. Genel olarak mantıklı ve tutarlı bir muhakeme sergiler. Bu düzey, çoğu rol için yeterli bir analitik temel sunar.",
    "Analitik muhakeme güçlü bir yönüdür; olayları çözümler, neden-sonuç ilişkilerini doğru kurar ve akılcı, veriye dayalı çözümler üretir. Karmaşık sorunları yapılandırarak, önemli değişkenleri ayırt ederek ele alır. Çıkarımlarını mantıklı bir gerekçelendirmeyle destekler ve kararlarını sağlam bir zemine oturtur. Nadiren, çok yüksek belirsizlik ya da eksik veri koşullarında analizi derinleştirmekte zorlanabilir. Analitik düşünme gerektiren rollerde güvenle görevlendirilebilir.",
    "Analitik muhakeme bu kişinin en belirgin güçlü yönlerindendir; karmaşık ve çok değişkenli verileri hızla çözümler ve isabetli, kanıta dayalı çıkarımlar yapar. Belirsizlik ve eksik bilgi altında dahi mantıklı bir yapı kurar, varsayımlarını sorgular ve en olası senaryoyu doğru biçimde öngörür. Sorunların kök nedenlerine iner ve yüzeysel çözümlerle yetinmez. Karar süreçlerine derinlik, öngörü ve netlik katar. Bu düzeydeki bir çalışan, karmaşık problemlerin çözümünde kuruma önemli bir analitik güç sağlar."],
  planlama:[
    "Planlama ve organizasyon bu düzeydeki bir kişi, işleri önceliklendirme, zaman ve kaynak yönetimi konusunda belirgin biçimde zorlanır. Görevleri düzenli bir sıraya koymakta, teslim tarihlerini yönetmekte ve iş yükünü dengelemekte güçlük çeker; bu da aksamalara ve son dakika yoğunluklarına yol açabilir. Beklenmedik durumlar karşısında planını hızla uyarlayamayabilir. Görev listeleri, önceliklendirme yöntemleri ve düzenli takip alışkanlıklarıyla yapılandırılmış biçimde desteklenmesi gerekir. Çok sayıda işin aynı anda yürütüldüğü rollerde yakın destek önerilir.",
    "Temel planlama yapar ve öngörülebilir işleri yürütebilir, ancak öncelikler karıştığında ya da iş yükü arttığında düzeni korumakta zorlanır. Aynı anda birden fazla iş söz konusu olduğunda hangisine öncelik vereceğini belirlemede tereddüt edebilir. Zaman yönetimi ve takip konusunda zaman zaman aksamalar yaşanabilir. Önceliklendirme çerçeveleri, planlama araçları ve düzenli gözden geçirme bu kişiyi belirgin biçimde güçlendirir. Net bir iş akışı ve destekle organizasyonu iyileşir.",
    "Beklenen düzeyde planlar ve işlerini organize eder; öncelikleri makul biçimde belirler ve zamanını genellikle iyi yönetir. Rutin iş yükünü düzenli biçimde yürütür. Aynı anda çok sayıda önceliğin olduğu ya da ani değişikliklerin yaşandığı yoğun durumlarda zaman zaman desteğe ihtiyaç duyabilir. Planını genellikle takip eder; beklenmedik durumlarda uyarlama becerisi orta düzeydedir. Bu düzey, çoğu rol için yeterli bir organizasyon zemini sunar.",
    "Planlama ve organizasyon güçlü bir yönüdür; işlerini önceliklendirir, planlı ve düzenli ilerler ve zamanını verimli yönetir. Kaynakları etkin kullanır ve teslim tarihlerini genellikle sorunsuz yönetir. Beklenmedik durumlarda planını çoğunlukla hızla ve isabetli biçimde uyarlar. Nadiren, aşırı yoğun ya da çok sayıda önceliğin çakıştığı dönemlerde zorlanabilir. Planlama ve koordinasyon gerektiren rollerde güvenle görevlendirilebilir.",
    "Planlama ve organizasyon bu kişinin en belirgin güçlü yönlerindendir; karmaşık ve yoğun iş yükünü bile düzenli, öngörülü ve verimli biçimde yönetir. Öncelikleri net biçimde kurar, kaynakları en etkin şekilde kullanır ve olası aksaklıkları önceden görüp önlem alır. Beklenmedik değişimlerde planını hızla ve isabetle yeniden düzenler, akışı bozmadan ilerler. Hem kendi işini hem de gerektiğinde ekip iş akışını sistemli biçimde organize edebilir. Bu düzeydeki bir çalışan, karmaşık süreçlerin sorunsuz yürümesinde kuruma önemli katkı sağlar."],
  hafiza:[
    "Görsel hafıza ve dikkat bu düzeydeki bir kişi, görsel bilgiyi hatırlama ve dikkatini sürdürme konusunda belirgin biçimde zorlanır; ayrıntılar hızla kaybolabilir. Kısa süre gösterilen bilgileri, desenleri ya da ekrandaki verileri doğru biçimde akılda tutmakta güçlük çeker. Yoğun bilgi akışı ya da uzun süreli dikkat gerektiren görevlerde odağı kolayca dağılabilir. Bilgiyi pekiştirme, not alma ve tekrar gibi destekleyici yöntemlere ihtiyaç duyar. Yoğun görsel/işlemsel dikkat gerektiren görevlerde hata riskine karşı destek önerilir.",
    "Kısa süreli görsel bilgiyi kısmen hatırlar ve rutin dikkat görevlerini yürütebilir, ancak yoğunlukta ya da uzun süreli görevlerde dikkatini sürdürmekte zorlanır. Bilgi akışı arttığında bazı ayrıntıları gözden kaçırabilir. Odağını uzun süre tek bir uyarana yönlendirmede zaman zaman zorlanır. Bilgiyi pekiştirme yöntemleri, düzenli molalar ve dikkat egzersizleriyle desteklenmesi fayda sağlar. Uygun iş akışıyla dikkat performansı istikrar kazanır.",
    "Beklenen düzeyde görsel hafıza ve dikkate sahiptir; çoğu bilgiyi doğru hatırlar ve dikkatini makul biçimde sürdürür. Rutin görsel ve işlemsel görevleri güvenilir biçimde yürütür. Uzun süreli, monoton ya da çok yoğun dikkat gerektiren durumlarda zaman zaman kısa süreli kaymalar yaşayabilir. Genel olarak odağını koruyabilir; kritik görevlerde destekleyici yöntemlerden fayda görür. Bu düzey, çoğu rol için yeterli bir dikkat zemini sunar.",
    "Görsel hafıza ve dikkat güçlü bir yönüdür; görsel bilgiyi doğru hatırlar ve dikkatini uzun süre iyi biçimde sürdürür. Yoğun bilgi akışında büyük ölçüde odağını korur ve ayrıntıları isabetle yakalar. Karmaşık görsel/işlemsel görevlerde tutarlı bir performans sergiler. Nadiren, çok uzun süren ya da olağanüstü yoğun görevlerde dikkatinde kısa süreli dalgalanma olabilir. Dikkat ve hafıza gerektiren rollerde güvenle görevlendirilebilir.",
    "Görsel hafıza ve dikkat bu kişinin en belirgin güçlü yönlerindendir; ayrıntıları hızla, doğru ve kalıcı biçimde hatırlar ve dikkatini uzun süre üst düzeyde korur. Yoğun ve uzun süreli görevlerde bile odağını ve doğruluğunu kaybetmez. Karmaşık görsel verileri zihninde canlandırma ve işleme konusunda üstün bir kapasiteye sahiptir. Dikkat dağıtıcı unsurların yoğun olduğu ortamlarda dahi performansını sürdürebilir. Bu düzeydeki bir çalışan, yüksek dikkat gerektiren süreçlerde kuruma güçlü bir güvence sağlar."]
};
          ...
          <div class="oryan-kategori-body">
            ${grp.satirlar.map((m) => `
              <div class="oryan-madde">
                ...
                ${(() => { const meta = [m.saat ? ("Saat " + esc(m.saat)) : "", m.sure ? (esc(m.sure) + " dk") : "", m.sorumlu ? ("Sorumlu: " + esc(m.sorumlu)) : "", (m.tamamlanmaTarihi || m.tarih) ? ("Tamamlandı: " + fmtTarih(m.tamamlanmaTarihi || m.tarih)) : ""].filter(Boolean).join(" · "); return meta ? `<div class="sorumlu">${meta}</div>` : ""; })()}
              </div>`).join("")}
          </div>
        </div>`;
      }).join("")}
